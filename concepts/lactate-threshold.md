...
4. **Time to exhaustion at threshold**
...
1. **Lactate threshold is the best predictor of distance running performance** - more important than VO2 max for races 10K and longer

2. **Your threshold is roughly your 60-minute race pace** - use 10K time to estimate

3. **Train threshold with tempo runs** - 20-40 minutes at "comfortably hard" pace, once per week

4. **Don't run tempos too fast** - should be sustainable effort, not all-out

5. **Threshold improves significantly with training** - gains continue for years

6. **Easy running supports threshold work** - can't improve threshold without aerobic base and recovery
...
**Next:** [The Easy/Hard Rule](./easy-hard.md)
