...
1. **Lower resting heart rate** - Often drops 5-10 bpm over months
2. **Lower heart rate at same pace** - Same run feels easier
3. **Faster pace at same heart rate** - Running faster at same effort
4. **Better recovery** - Less sore, bounce back quicker
5. **More energy** - Runs feel easier overall
6. **Longer runs become possible** - Endurance improves
...
**Next:** [Recovery and Adaptation](./recovery.md)
