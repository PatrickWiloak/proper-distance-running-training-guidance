...
**Physiological Benefits:**
- Increases VO2 max (maximum oxygen processing)
- Improves running economy
- Develops speed endurance
- Enhances neuromuscular coordination

**Recovery:** Should feel mostly recovered before starting next interval

**Common Mistake:** Running these too fast, which turns them into speed work and defeats the purpose.

**Jack Daniels calls this:** I pace (Interval pace)
**McMillan calls this:** VO2 max pace

---

### 5. Repetitions (Speed Work)

**Purpose:** Improve running economy, neuromuscular power, and pure speed

**Characteristics:**
- Very hard effort (faster than 5K pace)
- Short duration (30 seconds to 2 minutes)
- Full or near-full recovery between reps
- Focus on form and efficiency

**Typical Workouts:**
- 8-12 x 400m with 400m jog recovery
- 6-8 x 200m with full recovery
- Hill repeats: 8-10 x 30-60 seconds uphill

**Target Pace:**
- Mile to 3K race pace or faster
- Should feel fast but controlled
- Complete recovery between reps

**Physiological Benefits:**
- Improves running economy (efficiency)
- Develops fast-twitch muscle fibers
- Enhances stride power and turnover
- Builds speed reserve for racing

**When to Use:**
- Less important for marathoners, more important for 5K/10K runners
- Best used in race-specific training phases
- Often done on a track for precision

**Jack Daniels calls this:** R pace (Repetition pace)

---

## How to Combine These Workouts

### Weekly Structure Example (Intermediate Runner)

**Monday:** Easy run (30-45 min)
**Tuesday:** Tempo run or intervals
**Wednesday:** Easy run (30-45 min)
**Thursday:** Easy run (30-45 min) or rest
**Friday:** Easy run (30-45 min)
**Saturday:** Long run (90-120 min)
**Sunday:** Rest or easy run (30 min)
...
**General Preparation:**
- Add tempo runs
- Introduce some intervals
- Maintain base volume

**Race-Specific:**
- Add race-pace work
- Simulate race conditions
- Maintain intensity, reduce volume slightly
...
1. **Each workout type has a specific purpose** - don't mix them up or skip types
2. **Easy runs should be truly easy** - this is where most runners go wrong
...
**Next:** [The Aerobic System](./aerobic-system.md)
